...
public class PreProcess extends Stage {
    ...
    protected void execute(StagePipeline.StageMap previousStages) {
        ...
        mSensorTex = new GLTex(converter.inWidth, converter.inHeight, 1, GLTex.Format.Float16, null);
        ...
        try (GLTex sensorUITex = new GLTex(converter.inWidth, converter.inHeight, 1, GLTex.Format.UInt16, buffer)) {
