...
import static amirz.dngprocessor.math.ColorspaceConstants.D50_XYZ;
import static amirz.dngprocessor.math.ColorspaceConstants.NO_ILLUMINANT;
import static amirz.dngprocessor.math.ColorspaceConstants.sStandardIlluminants;

public class RawConverter {
    protected static final String TAG = "RawConverter";

    protected static final boolean DEBUG = true;

    protected float[] mapWhiteMatrix(float[] sensorWhiteXYZ) {
        float[] Mb = {
     ...
     */
    protected static double calculateColorTemperature(double x, double y) {
     ...
     */
    protected static double[] calculateCIExyCoordinates(double X, double Y, double Z) {
     ...
     */
    protected static double lerp(double a, double b, double f) {
        return (a * (1.0f - f)) + (b * f);
    }
     ...
     */
    protected static void lerp(float[] a, float[] b, double f, /*out*/float[] result) {
        for (int i = 0; i < 9; i++) {
     ...
     */
    protected static double findDngInterpolationFactor(int referenceIlluminant1,
     ...
     */
    protected static void calculateCameraToXYZD50TransformFM(float[] forwardTransform1, float[] forwardTransform2,
     ...
     */
    protected static void map(float[] matrix, float[] input, /*out*/float[] output) {
     ...
     */
    protected static void multiply(float[] a, float[] b, /*out*/float[] output) {
    ...
    protected static boolean invert(float[] m, /*out*/float[] output) {
        double a00 = m[0];
        double a01 = m[1];
        double a02 = m[2];
        double a10 = m[3];
     ...
     */
    protected static void scale(float factor, /*inout*/float[] matrix) {
        for (int i = 0; i < 9; i++) {
            matrix[i] *= factor;
        }
    }
     ...
     */
    protected static void normalizeCM(/*inout*/float[] colorMatrix) {
     ...
     */
    protected static void normalizeFM(/*inout*/float[] forwardMatrix) {
